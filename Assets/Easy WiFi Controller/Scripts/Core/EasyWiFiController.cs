    ...
    public static class EasyWiFiController
    {
        ...
        public static void listen()
        {
            ...
            while (true)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    if (isVerbose)
                    {
                        Debug.Log("Normal socket listening interrupted to exit. Source:" + exception);
                    }
                    break;                    
                }
            }
        ...
        public static void listenClientControllerData(string message)
        {
            ...
            for (int i = 0; i < splitMessage.Length; i++)
            {
                ...
                {
                    var iiii = Convert.ToInt32(packetNumber);
                    controllerDataDictionary[currentServerKey].mapNetworkDataToStructure(iiii, splitMessage2[1]);
                }
            }
        }
